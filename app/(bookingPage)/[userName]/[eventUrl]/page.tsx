          ...
          <div>
            ...
            <div className="mt-5 flex flex-col gap-y-3">
              ...
              <p className="flex items-center">
                ...
                <span className="text-sm font-medium text-muted-foreground">25. Jan 2025</span>
              </p>

              <p className="flex items-center">
                <Clock className="size-4 mr-2 text-primary" />
                <span className="text-sm font-medium text-muted-foreground">{data.duration} Mins</span>
              </p>
