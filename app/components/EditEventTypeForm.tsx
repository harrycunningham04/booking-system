...
export function EditEventForm({id, title, description, duration, url, callProvider} : iAppProps) {
    ...
    <div className="w-full h-full flex flex-1 items-center justify-center">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Edit your appointment type details here.
          </CardDescription>
        </CardHeader>
          ...
          <CardContent className="grid gap-y-5">
            ...
            <div className="flex flex-col gap-y-2">
              ...
              <Textarea
                ...
                placeholder="Meet me in this meeting to..."
              />
